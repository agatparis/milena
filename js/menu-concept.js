...
const menuIconCode = `
        ...
        <div class="menu-icon__border"></div>
      `;


const menuIconCode = `
<svg class="ham ham3" viewBox="0 0 100 100" width="80" onclick="this.classList.toggle('active2')">
  <path
        class="line top"
...
const menuIconCode = `
<div id="menu-open-close-item" class="ham ham3">
